...
class FullyDecomposedGlobalHeadProbEncoder(nn.Module):
    """
    Head Probabilistic Transformer encoder with global nodes.

    A combination of "SingleGlobalHeadProbEncoder" and "FullyDecomposedHeadProbEncoder".
    """
    def __init__(self, 
            d_model: int = 32, 
            n_head: int = 10, 
    ...
    def forward(self, x, mask):
        ...
        ## Recover ternary score
        if self.use_td.startswith('uv:'):
            expr_F = oe.contract_expression('zia,zjb,acd,bcd,ijd->zcij',*[size_qz, size_qz, self.U, self.V, distmask], constants=[2,3,4], optimize='optimal')
            expr_G1 = oe.contract_expression('zjb,zcij,acd,bcd,ijd->zia', *[size_qz, size_qh1, self.U, self.V, distmask], constants=[2,3,4], optimize='optimal')
            expr_G2 = oe.contract_expression('zjb,zcji,bcd,acd,jid->zia', *[size_qz, size_qh1, self.U, self.V, distmask], constants=[2,3,4], optimize='optimal')
        elif self.use_td.startswith('uvw:'):
            expr_F = oe.contract_expression('zia,zjb,ad,bd,cd,ijd->zcij',*[size_qz, size_qz, self.U, self.V, self.W, distmask], constants=[2,3,4,5], optimize='optimal')
            expr_G1 = oe.contract_expression('zjb,zcij,ad,bd,cd,ijd->zia', *[size_qz, size_qh1, self.U, self.V, self.W, distmask], constants=[2,3,4,5], optimize='optimal')
            expr_G2 = oe.contract_expression('zjb,zcji,bd,ad,cd,jid->zia', *[size_qz, size_qh1, self.U, self.V, self.W, distmask], constants=[2,3,4,5], optimize='optimal')
        else:
            expr_F = oe.contract_expression('zia,zjb,abcd,ijd->zcij',*[size_qz, size_qz, self.UVW, distmask], constants=[2,3], optimize='optimal')
            expr_G1 = oe.contract_expression('zjb,zcij,abcd,ijd->zia', *[size_qz, size_qh1, self.UVW, distmask], constants=[2,3], optimize='optimal')
            expr_G2 = oe.contract_expression('zjb,zcji,bacd,jid->zia', *[size_qz, size_qh1, self.UVW, distmask], constants=[2,3], optimize='optimal')
